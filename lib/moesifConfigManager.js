...
MoesifConfigManager.prototype._getSampleRate = function (userId, companyId) {
  ...
  if (
    userId &&
    this._config.user_sample_rate &&
    typeof this._config.user_sample_rate[userId] === 'number'
  ) {
  ...
  if (
    companyId &&
    this._config.company_sample_rate &&
    typeof this._config.company_sample_rate[companyId] === 'number'
  ) {
