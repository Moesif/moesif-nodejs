...
GovernanceRulesManager.prototype.hasConfig = function () {
  return Boolean(this._rules && this._rules.length > 0);
};

GovernanceRulesManager.prototype.shouldFetchConfig = function () {
...
GovernanceRulesManager.prototype.tryGetConfig = function () {
...
GovernanceRulesManager.prototype._getSampleRate = function (userId, companyId) {
...
GovernanceRulesManager.prototype.shouldSend = function (userId, companyId) {
