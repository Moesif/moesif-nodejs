...
function ensureValidSubscriptionModel(subscriptionModel) {
  if (!subscriptionModel.companyId && !subscriptionModel.subscriptionId) {
    throw new Error('To update a subscription, subscriptionId & companyId fields are required');
  }
}

function ensureValidSubscriptionsBatchModel(subscriptionsBatchModel) {
  for (let subscriptionModel of subscriptionsBatchModel) {
    if (!subscriptionModel.companyId && !subscriptionModel.subscriptionId) {
      throw new Error('To update a subscription, subscriptionId & companyId fields are required');
    }
  }
...
module.exports = {
  ...
  ensureValidSubscriptionModel: ensureValidSubscriptionModel,
  ensureValidSubscriptionsBatchModel: ensureValidSubscriptionsBatchModel
};
