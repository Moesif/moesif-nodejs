...
var logMessage = function(debug, functionName, message, jsonObject) {
  if (debug) {
    var finalMessage = jsonObject ? message + '\n' + JSON.stringify(jsonObject) : message;
...
function computeBodySize(body) {
  ...
  if (typeof body === 'object') {
    return approximateObjectSize(obj);
  }
