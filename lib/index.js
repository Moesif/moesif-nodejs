...
module.exports = function(options) {
  ...
  var maskContentStartTime = Date.now();
  ...
  var maskContentEndTime = Date.now();
  logMessage(options.debug, 'maskContent took time ', timeTookInSeconds(maskContentStartTime, maskContentEndTime));
  ...
  logMessage(options.debug, 'skipOptions took time ', timeTookInSeconds(skipStartTime, skipEndTime));
