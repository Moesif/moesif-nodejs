...
function makeMoesifMiddleware(options) {
  ...
  moesifMiddleware.updateSubscription = function (subscriptionModel, cb) {
    var subscription = new CompanyModel(subscriptionModel);
    ...
    if (cb) {
      ...
      return new Promise(function (resolve, reject) {
        moesifController.updateSubscription(company, function (err, response) {
          if (err) {
            reject(err);
          } else {
            resolve(response);
  ...
  moesifMiddleware.updateSubscriptionBatch = function (subscriptionBatchModel, cb) {
    ...
    logMessage(options.debug, 'updateSubscriptionsBatch', 'convertedSubscriptionsArray=', companiesBatch);
    if (cb) {
